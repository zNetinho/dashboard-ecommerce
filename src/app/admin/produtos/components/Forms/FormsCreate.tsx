...
export default function FormsCreateProduto({token}: any) {
    ...
    async function onSubmit(data: updateProductFormData, e) {
        console.log("Entrou no callback do HOF", e);
        try {
    ...
    return (
        <div>
            ...
            <form onSubmit={(e) => { console.log("handleSubmit called"); handleSubmit(onSubmit, e);}}>
                <div>
                ...
                <div>
                    ...
                    <Input 
                        ...
                        { ...register("preco")}
                    />
                    { errors.preco && <span className="text-red-400"> { errors.preco?.message } </span> }
                </div>
                <div>
                    ...
                    <Input
                        type="file"
                        id="Imagens do produto"
                        { ...register("img")}
                    />
                    { errors.descricao && <span className="text-red-400"> { errors.img?.message } </span> }
                </div>
                <div>
                    <Label htmlFor="descricao">
                        Descricao
